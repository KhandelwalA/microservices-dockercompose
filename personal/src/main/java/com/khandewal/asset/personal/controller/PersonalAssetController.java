package com.khandewal.asset.personal.controller;
...
import com.khandewal.asset.personal.service.PersonalAssetService;
...
public class PersonalAssetController {
	...
	public ResponseEntity<Optional<PersonalAsset>> getPersonalAssetByNumber(@PathVariable String assetnumber) {

		return new ResponseEntity<Optional<PersonalAsset>>(personalAssetService.getPersonalAssetByNumber(assetnumber),
				HttpStatus.OK);
	}
