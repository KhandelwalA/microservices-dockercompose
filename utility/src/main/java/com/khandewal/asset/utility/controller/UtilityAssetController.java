package com.khandewal.asset.utility.controller;
...
import com.khandewal.asset.utility.service.UtilityAssetService;
...
public class UtilityAssetController {
	...
	public ResponseEntity<Optional<UtilityAsset>> getUtilityAssetByNumber(
			@PathVariable String assetnumber) {

		return new ResponseEntity<Optional<UtilityAsset>>(
	...
	/*
	 * @DeleteMapping(value =
	 * "/deleteByAssetNumberOrMeterNumber/{assetNumber}/{meterNumber}") public void
	 * deleteByAssetNumberOrMeterNumber(
	 * 
